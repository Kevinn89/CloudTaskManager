...
class TaskServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        owner = userEntityRepository.save(
                UserEntity.builder()
                        .name("Kevin")
        ...
        otherUser = userEntityRepository.save(
                UserEntity.builder()
                        .name("Other User")
        ...
        ownerProject = projectRepository.save(
        ...
        secondOwnerProject = projectRepository.save(
                ProjectEntity.builder()
        ...
        otherUserProject = projectRepository.save(
                ProjectEntity.builder()
    ...
    void getTasksShouldReturnOnlyTasksForRequestedProjectAndCurrentUser() {
        ...
        TaskEntity expectedTask = taskRepository.save(
                TaskEntity.builder()
    ...
    void updateTaskShouldPersistChangesWhenTaskBelongsToRequestedProjectAndCurrentUser() {
        ...
        TaskEntity updatedTask = taskRepository.findById(task.getId())
                .orElseThrow();
    ...
    void updateTaskShouldThrowUnauthorizedWhenProjectBelongsToAnotherUser() {
        ...
        TaskEntity otherUserTask = taskRepository.save(
                TaskEntity.builder()
    ...
    @Test
    void updateTaskShouldThrowResourceNotFoundWhenTaskBelongsToDifferentProjectEvenIfUserOwnsBothProjects() {
        // Why: proves user cannot update a Project B task through a Project A route.
        when(currentUserService.getCurrentUserId()).thenReturn(owner.getId());

        TaskEntity taskInSecondProject = taskRepository.save(
                TaskEntity.builder()
    ...
    @Test
    void deleteTaskShouldThrowResourceNotFoundWhenTaskBelongsToDifferentProjectEvenIfUserOwnsBothProjects() {
    ...
    void deleteTaskShouldThrowResourceNotFoundWhenTaskBelongsToDifferentUserEvenIfProjectIdMatches() {
        ...
        assertThatThrownBy(() ->
                taskService.deleteTask(ownerProject.getId(), otherUserTask.getId())
        )
                .isInstanceOf(ResourceNotFoundException.class)
                .hasMessage("Task not found for project " + ownerProject.getId());
