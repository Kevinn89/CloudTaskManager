...
public class AuthController {
  ...
  public ResponseEntity<Void> refresh(HttpServletRequest request) {
    ...
    ResponseCookie accessTokenCookie = ResponseCookie.from(ACCESS_TOKEN_NAME, newAccessToken.token())
  ...
  public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest request) {
    return ResponseEntity.ok(
        authService.registerUser(request.name(), request.email(), request.password(), request.accountType()));
  }
  ...
  public ResponseEntity<AuthResponse> login(@Valid @RequestBody LoginRequest request) {
    ...
    ResponseCookie accessTokenCookie = ResponseCookie.from(ACCESS_TOKEN_NAME, response.token())
        .httpOnly(true)
    ...
    ResponseCookie refreshTokenCookie = ResponseCookie.from(REFRESH_TOKEN_NAME, response.refreshToken())
        .httpOnly(true)
        .secure(false) // true in production HTTPS
  ...
  public ResponseEntity<Void> logout(HttpServletRequest request) {
    ...
    ResponseCookie clearAccessTokenCookie = ResponseCookie.from(ACCESS_TOKEN_NAME, "")
    ...
    ResponseCookie clearRefreshTokenCookie = ResponseCookie.from(REFRESH_TOKEN_NAME, "")
